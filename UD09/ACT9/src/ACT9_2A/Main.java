...
public class Main {
    public static void main(String[] args) {
        ...
        Telefon telefon1 = new Android("Samsung1", persona1, false, "1111", "teclado1", "empremta1");
        telefons.add(telefon1);
        Telefon telefon2 = new Android("Samsung2", persona2, false, "2222", "teclado2", "empremta2");
        telefons.add(telefon2);
        Telefon telefon3 = new IPhone8("Apple8", persona3, false, "3333", "empremta3");
        telefons.add(telefon3);
        Telefon telefon4 = new IPhone10("Apple10", persona4, false, "4444", "empremta4", "rostro4");
        telefons.add(telefon4);
