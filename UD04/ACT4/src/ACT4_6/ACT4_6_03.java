...
public class ACT4_6_03 {
    ...
    public static void main(String[] args) {
        ...
        UtilitatsTauler.emplenaTauler3(tauler, cuc, NFULLES);
        do{
            UtilitatsMatrius.mostraMatriu(tauler);
            accio = UtilitatsConsola.llegirSencer("Puntuación = " + simbolCuc + " | 2 = Abajo | 4 = Izquierda | 6 = Derecha | 8 = Arriba | 0 = Salir del juego -> ");
            System.out.println();
            if(accio == 2 || accio == 4 || accio == 6 || accio == 8){
                UtilitatsTauler.cambiaPosicio3(tauler, cuc, accio);
                accio = (simbolCuc == 0 ? 0 : accio);
            }
        }
        while(accio != 0);
    }
